...
function AboutMe() {
  ...
  return (
    <div className={`aboutme ${isVisible ? 'animate' : ''}`} id="about" ref={containerRef}>
      ...
      <h1 className={`aboutme__title ${isVisible ? 'slideInFromLeft' : ''}`}>Software Developer</h1>
      ...
      <p className={`aboutme__description; ${isVisible ? 'slideInFromRight' : ''}`}>
        I also enjoy building backend.
      </p>

      <h1 className={`aboutme__title ${isVisible ? 'slideInFromLeft' : ''}`}>Free Time</h1>
      <p className={`aboutme__description; ${isVisible ? 'slideInFromRight' : ''}`}>
        I like to read books about self-improvement, phychology, finances and coding related. <br />
      </p>
      <p className={`aboutme__description; ${isVisible ? 'slideInFromRight' : ''}`}>
